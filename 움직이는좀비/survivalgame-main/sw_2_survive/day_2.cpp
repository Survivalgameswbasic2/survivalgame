...
void zombieMoveThread2(std::vector<Zombie>& zombies, char game_map[][MAP_HEIGHT][MAP_WIDTH + 1], player* user) {
...
void start_day2(player* user) {
	...
	//좀비 이동 별도 쓰레드
	std::thread zombieThread(zombieMoveThread2, std::ref(zombies), game_map, user);
